export default function MentionsLegales() {
  return (
    <main className="px-7 md:px-16 pb-20 pt-40">
      <h1 className="text-xl">Mentions Légales</h1>
      <h2 className="mt-6 font-bold text-lg">Définitions</h2>
      <p className="mt-2.5">
        ...
        <a href="https://nephos-app.vercel.app">
          https://nephos-app.vercel.app
        </a>{" "}
      ...
      <p className="mt-2.5">
        ...
        sous quelque forme que ce soit, directement ou non, l&pos;identification
        des personnes physiques auxquelles elles s&pos;appliquent » (article 4
      ...
      <p className="mt-2.5">
        En vertu de l&pos;article 6 de la loi n° 2004-575 du 21 juin 2004 pour
        la confiance dans l&pos;économie numérique, il est précisé aux
        utilisateurs du site internet{" "}
        <a href="https://nephos-app.vercel.app">
          https://nephos-app.vercel.app
        </a>{" "}
        l&pos;identité des différents intervenants dans le cadre de sa
        réalisation et de son suivi:
      </p>
      <p className="mt-2.5">
        <strong>Propriétaire</strong> : Christian Biango – 1 rue de Paris 75000
        Paris
        <br />
        <strong>Responsable publication</strong> : Christian Biango –
        biangochristian1@gmail.com
        <br />
        Le responsable publication est une personne physique ou une personne
        morale.
        <br />
        <strong>Webmaster</strong> : Christian Biango –
        biangochristian1@gmail.com
        <br />
        <strong>Hébergeur</strong> : Vercel – San Francisco; États-Unis 0000000
        San Francisco 00000000000
        <br />
        <strong>Délégué à la protection des données</strong> : Christian Biango
        – biangochristian1@gmail.com
        <br />
      </p>
      ...
      <p className="mt-2.5">
        ...
        responsable du traitement des Données Personnelles est : Christian
        Biango.{" "}
        <a href="https://nephos-app.vercel.app">
          https://nephos-app.vercel.app
        </a>
        est représenté par Christian Biango, son représentant légal
      </p>
      <p className="mt-2.5">
      ...
      <ul>
        <li>
          droit d&pos;accès (article 15 RGPD) et de rectification (article 16
          ...
          l&pos;utilisation, la communication ou la conservation est
          interdite{" "}
        </li>
        <li>
      ...
      Christian Biango – DPO, Christian Biango <br />1 rue de Paris 75000 Paris.
      <p className="mt-2.5">
      ...
      <h2 className="mt-6 font-bold text-lg">8. Notification d’incident</h2>
      <p className="mt-2.5">
        Quels que soient les efforts fournis, aucune méthode de transmission sur
        Internet et aucune méthode de stockage électronique n&pos;est
        complètement sûre. Nous ne pouvons en conséquence pas garantir une
        sécurité absolue. Si nous prenions connaissance d&pos;une brèche de la
        sécurité, nous avertirions les utilisateurs concernés afin qu&pos;ils
        puissent prendre les mesures appropriées. Nos procédures de notification
        d’incident tiennent compte de nos obligations légales, qu&pos;elles se
      ...
      <p className="mt-2.5">
        Aucune information personnelle de l&pos;utilisateur du site{" "}
        <a href="https://nephos-app.vercel.app">
          https://nephos-app.vercel.app
        </a>{" "}
        ...
        l&pos;hypothèse du rachat de{" "}
        <a href="https://nephos-app.vercel.app">
          https://nephos-app.vercel.app
        </a>{" "}
        et de ses droits permettrait la transmission des dites informations à
        l&pos;éventuel acquéreur qui serait à son tour tenu de la même
        obligation de conservation et de modification des données vis à vis de
        l&pos;utilisateur du site{" "}
        <a href="https://nephos-app.vercel.app">
          https://nephos-app.vercel.app
        </a>
        .
      </p>
      <h3 className="mt-6 font-bold text-base">Sécurité</h3>
      <p className="mt-2.5">
      ...
      <h3 className="mt-6 font-bold text-base">9.1. « COOKIES »</h3>
      <p className="mt-2.5">
