...
export default function PolitiqueDeConfidentialite() {
  return (
    <main className="px-7 md:px-16 pb-20 pt-40">
      <h1 className="text-xl">Politique de confidentialité</h1>
      <div>
        <br />
      </div>
      <div>
      ...
      <div>
        ...
        utilisées à certaines fins mentionnées lors de la collecte.
      </div>
      <div>
        <br />
      </div>
      ...
      <h2 className="font-bold mt-6 text-lg">Droit d’accès</h2>
      <div>
      ...
      <h2 className="font-bold mt-6 text-lg">Sécurité</h2>
      <div>
      ...
      <h2 className="font-bold mt-6 text-lg">Législation</h2>
      <div>
