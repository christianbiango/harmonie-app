...
CREATE OR REPLACE FUNCTION "public"."handle_new_user_type"() RETURNS "record"
    LANGUAGE "plpgsql"
    AS $$DECLARE
  user_type TEXT;
BEGIN
...
ALTER TABLE ONLY "public"."doctors"
    ADD CONSTRAINT "doctors_id_fkey" FOREIGN KEY ("id") REFERENCES "auth"."users"("id") ON UPDATE CASCADE ON DELETE CASCADE;
